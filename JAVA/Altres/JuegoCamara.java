...
public class JuegoCamara {
    ...
    static int leerEntero(String mensaje, int min, int max) {
        ...
        do {
            ...
            if (!sc.hasNextInt()) {
                System.out.println("Introducción incompatible");
                sc.next();
                continue;
            }
    ...
    static void configurarDificultad() {
        ...
        LONGITUD_CLAVE=leerEntero("Introduce min 1, max 10", 1, 10);
        // TODO: Pedir nuevo valor máximo (mínimo 2, máximo 9)
        MAX_VALOR=leerEntero("Introduce nº min 2, max 9", 2, 9);
    ...
    static int[] pedirCombinacionUsuario() {
        ...
        for (int i = 0; i < LONGITUD_CLAVE; i++) {
            intento[i]=leerEntero(null, 1, MAX_VALOR);
        }
    ...
    static void jugarPartida() {
        ...
        do {
            if (generarSecreto()!= pedirCombinacionUsuario()) {
